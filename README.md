...
把 AirPods 的 **单击 / 双击 / 三击** stem 手势映射到任意键盘按键的 macOS 菜单栏小工具。专为搭配 [Typeless](https://typeless.dev/) / [WhisperKey](https://whisperkey.app/) 这类「按住 Opt 录音」的 AI 输入工具设计 —— 戴着 AirPods 单击一下就开录，再单击一下就上文字。
...
| 设备 | 状态 | 说明 |
|---|---|---|
| AirPods 1 / 2 / 3 / 4（普通版） | ✅ 工作 | 全部三种手势可拦截 |
| AirPods Max | ✅ 工作 | 同普通版 |
| **AirPods Pro 2 / Pro 3** | ❌ **不支持** | Apple 改了 Pro 2 stem 单击的事件路径，走 MediaRemote 私有 IPC，**绕过 CGEventTap**。Karabiner-Elements、SiriMote 等同类工具对 Pro 2 也都失效（详见下方「为什么 Pro 2 不工作」）。 |
| AirPods Pro 1 | ⚠️ 待测试 | 理论上工作 |

**如果你的 AirPods 是 Pro 2 / Pro 3，这个工具帮不了你**。这是 macOS 系统级限制，不是本项目的 bug。

---

## 功能

- **三种手势**：单击 / 双击 / 三击 stem，分别可独立映射
- **两种触发模式**：
...
不能。详见上方「兼容性」。把 AirPods Pro 2 设置里的「按 stem」选项改成不同动作也无法绕过。
...
这是 Apple 在 macOS Sonoma 时期改的设计。第三方 app 拦不到，**所有同类工具（Karabiner-Elements、SiriMote、AirPodsRemap）对 Pro 2 都失效**。详见 [Karabiner-Elements Issue #2398](https://github.com/pqrs-org/Karabiner-Elements/issues/2398)（开 6 年未解决）。
...
1. **AirPods Pro 2 / Pro 3 不支持**（详见上方「为什么 Pro 2 不工作」）
...
- [Karabiner-Elements](https://karabiner-elements.pqrs.org/) — Issue #2398 帮我们确认了 Pro 2 限制
